...
#---parameters---#
heights_ = np.round(np.linspace(start=0, stop=0.75, endpoint=True, num=61), 4)
...
##---paths---#
BWWall_path_ = "../newdat/bumps_with_wall_redo_part3/"
if not os.path.isdir(BWWall_path_):
    print("directory created for bumps with wall part3")
