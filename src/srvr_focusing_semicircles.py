...
depths_ = np.round(np.linspace(start=0, stop=1, num=150, endpoint=True), 4)
...
BWHole_path_ = "../newdat/semicircles_focus/"
if not os.path.isdir(BWHole_path_):
    print("directory created for semicircles FOCUS")
...
for d_ in depths_:
    ...
    segments_ = gbc.semicircle_focus_family(d_)
